<template>
    <div class="comment">
        <div class="temimi-comment browser-pc">
...
export default {
    ...
    data() {
        return {
            ...
            commentInfo: {
                root_id: 0,
                parent_id: 0,
                to_user_id: 0,  // 初始化为0，发布评论时会自动填充
                vid: -1,  // 初始化为-1，mounted时会设置
            },
    ...
    mounted() {
        // 初始化 commentInfo
        this.commentInfo.vid = this.$route.params.vid || -1;
        this.commentInfo.to_user_id = this.uid || 0;
