...
export default {
    ...
    setup() {
        ...
        return { favoriteStore, videoStore };
    },
    data() {
        return {
    ...
    methods: {
        ...
        async create() {
            ...
            this.favoriteStore.favorites.splice(1, 0, res.data.data);    // 在第二个位置插入新收藏夹，即默认收藏夹后面
            this.input = "";
        ...
        async submit() {
            ...
            // ✅ 关键修复：将更新后的收藏夹列表同步回 store
            this.favoriteStore.setFavorites(this.favorites);
    ...
    created() {
        this.favorites = JSON.parse(JSON.stringify(this.favoriteStore.favorites));
