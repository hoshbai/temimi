<template>
    <div class="header-channel">
        ...
        <div class="right-channel-container">
            <!-- 中间频道 -->
            <div class="channel-items__left" v-if="channels.length >= 2">
                <!-- 番剧 -->
                <VPopover class="channel-link" placement="top" popStyle="z-index: 2000; cursor: default;" v-if="channels[0] && channels[0].scList">
                    <template #reference>
                ...
                <!-- 国创 -->
                <VPopover class="channel-link" placement="top" popStyle="z-index: 2000; cursor: default;" v-if="channels[1] && channels[1].scList">
                    <template #reference>
...
<script>
    ...
    export default {
        ...
        computed: {
            // 频道列表
            channels() {
                return this.videoStore?.channels || [];
            }
        },
        created() {
