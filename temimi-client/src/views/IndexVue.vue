        ...
        <div class="large-header">
            ...
            <!-- <div class="header__banner">
                ...
                <div class="header-banner__inner">
                    <div class="logo-box">
                        <img src="~assets/img/temimi-white.png" alt="">
                    </div>
                </div>
            </div> -->
            <header>
...
export default {
    ...
    methods: {
        ...
        async getRandomVideos() {
            ...
            try {
                const data = await this.videoStore.fetchRandomVideos();
                if (data) {
        ...
        async getCumulativeVideos() {
            ...
            try {
                ...
                if (data) {
                    this.cumulativeVideos.push(...data.videos);
                    this.vids.push(...data.vids);
                    this.hasMore = data.more;
                }
            } catch (error) {
                console.error('Failed to fetch cumulative videos:', error);
            } finally {
