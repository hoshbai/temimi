...
export default {
    ...
    computed: {
        isCurrAvatar() {
            return !this.imgUrl || this.imgUrl === this.userStore.user.avatar_url || !this.userStore.user.uid;
        }
    },
    methods: {
        // 初始化
            ...
            .then(blob => {
                ...
                .then(res => {
                    if (res.data.code === 200) {
                        ...
                        this.userStore.user.avatar_url = res.data.data;
                    }
                })
            })
            .catch(() => {
    ...
    mounted() {
        ...
        if (this.userStore.user.avatar_url) {
            this.imgUrl = this.userStore.user.avatar_url;
        }
    },
    watch: {
        "userStore.user": {
