    ...
    <div class="account-info">
        ...
        <div class="info-wrap">
            ...
            <div class="form-item user-uid">
                ...
                <div class="form-item__content">
                    <span class="user-uid-text">{{ this.userStore.user.uid }}</span>
                </div>
            </div>
...
export default {
    ...
    computed: {
        hadChanged() {
            return this.nickname !== this.userStore.user.nickname ||
                    this.description !== this.userStore.user.description ||
    ...
    mounted() {
        if (this.userStore.user.nickname) {
